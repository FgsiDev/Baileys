  ...
  function getTemplateMessage(content) {
    ...
    return content.buttonsMessage
      ...
      : content.listMessage
        ...
        : content.templateMessage?.interactiveMessageTemplate
          ...
          : content.templateMessage?.hydratedFourRowTemplate
            ...
            : content.templateMessage?.hydratedTemplate
              ...
              : content.templateMessage?.fourRowTemplate
                ...
                : content.interactiveMessage?.shopStorefrontMessage
                  ? extractFromTemplateMessage(
                      content.interactiveMessage.shopStorefrontMessage,
                    )
                  : content.interactiveMessage?.collectionMessage
                    ? extractFromTemplateMessage(
                        content.interactiveMessage.collectionMessage,
                      )
                    : content.interactiveMessage?.nativeFlowMessage
                      ? extractFromTemplateMessage(
                          content.interactiveMessage.nativeFlowMessage,
                        )
                      : content.interactiveMessage?.carouselMessage
                        ? extractFromTemplateMessage(
                            content.interactiveMessage.carouselMessage,
                          )
                        : content;
