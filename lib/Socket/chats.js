...
const makeChatsSocket = (config) => {
    ...
    const fetchLidByJids = async (...jids) => {
        const validJids = jids.filter((jid) => (0, WABinary_1.isJidUser)(jid));
        if (validJids.length === 0)
            return [];
        const result = await sock.executeUSyncQuery({
            users: validJids.map((jid) => ({ id: jid })),
            protocols: [
                {
                    tag: "lid",
                    attrs: {},
            ...
            context: "interactive",
            mode: "query",
            parseUSyncQueryResult: (res) => {
                var _a, _b, _c;
                const usync = (_a = res === null || res === void 0 ? void 0 : res.content) === null || _a === void 0 ? void 0 : _a.find((c) => c.tag === "usync");
                const list = (_b = usync === null || usync === void 0 ? void 0 : usync.content) === null || _b === void 0 ? void 0 : _b.find((c) => c.tag === "list");
                const users = ((_c = list === null || list === void 0 ? void 0 : list.content) === null || _c === void 0 ? void 0 : _c.filter((c) => c.tag === "user")) || [];
                return users.map((user) => {
                    var _a;
                    return ({
                        jid: (_a = user === null || user === void 0 ? void 0 : user.attrs) === null || _a === void 0 ? void 0 : _a.jid,
                        lid: ((user === null || user === void 0 ? void 0 : user.content) || [])
                            .filter((child) => child.tag === "lid")
                            .map((lid) => { var _a; return (_a = lid === null || lid === void 0 ? void 0 : lid.attrs) === null || _a === void 0 ? void 0 : _a.val; })[0],
                    });
                });
            },
        });
