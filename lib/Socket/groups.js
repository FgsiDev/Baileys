    ...
    return {
        ...
        groupAcceptInviteV4: ev.createBufferedFunction(async (key, inviteMessage) => {
            ...
            if (key.id) {
                ...
                inviteMessage =
                    index_js_1.proto.Message.GroupInviteMessage.create(inviteMessage);
...
const extractGroupMetadata = (result) => {
    ...
    const metadata = {
        ...
        size: group.attrs.size
            ? +group.attrs.size
            : (0, WABinary_1.getBinaryNodeChildren)(group, "participant").length,
        creation: +group.attrs.creation,
        owner: group.attrs.creator
            ? (0, WABinary_1.jidNormalizedUser)(group.attrs.creator)
            : undefined,
        ownerPn: group.attrs.creator_pn
            ? (0, WABinary_1.jidNormalizedUser)(group.attrs.creator_pn)
            : undefined,
        ...
        participants: (0, WABinary_1.getBinaryNodeChildren)(group, "participant").map(({ attrs }) => {
            return {
                id: attrs.jid,
                phoneNumber: (0, WABinary_1.isLidUser)(attrs.jid) && (0, WABinary_1.isPnUser)(attrs.phoneNumber)
                    ? attrs.phoneNumber
                    : undefined,
