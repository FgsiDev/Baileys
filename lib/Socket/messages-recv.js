...
const makeMessagesRecvSocket = (config) => {
                ...
                processingMutex.mutex(async () => {
                    ...
                    if (typeof status !== "undefined" &&
                        ...
                        if ((0, WABinary_1.isJidGroup)(remoteJid) || (0, WABinary_1.isJidStatusBroadcast)(remoteJid)) {
                            if (attrs.participant) {
                                const updateKey = status === index_js_1.proto.WebMessageInfo.Status.DELIVERY_ACK
                                    ? "receiptTimestamp"
                                    : "readTimestamp";
    ...
    const handleMessage = async (node) => {
        ...
        if (((_c = (_b = msg.message) === null || _b === void 0 ? void 0 : _b.protocolMessage) === null || _c === void 0 ? void 0 : _c.type) ===
            index_js_1.proto.Message.ProtocolMessage.Type.SHARE_PHONE_NUMBER &&
        ...
        if (!!alt) {
            const altServer = (_d = (0, WABinary_1.jidDecode)(alt)) === null || _d === void 0 ? void 0 : _d.server;
                ...
                processingMutex.mutex(async () => {
                    ...
                    if (msg.messageStubType === index_js_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        ...
                        if (category === "peer") {
                            ...
                            if ((0, WABinary_1.isLidUser)(msg.key.remoteJid) ||
                                (0, WABinary_1.isLidUser)(msg.key.remoteJidAlt)) {
