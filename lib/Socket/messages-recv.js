...
import { areJidsSameUser, getAllBinaryNodeChildren, getBinaryNodeChild, getBinaryNodeChildBuffer, getBinaryNodeChildren, getBinaryNodeChildString, isJidGroup, isJidStatusBroadcast, isLidUser, jidDecode, jidNormalizedUser, S_WHATSAPP_NET, } from "../WABinary";
...
export const makeMessagesRecvSocket = (config) => {
    ...
    const handleGroupNotification = (participant, child, msg) => {
        var _a, _b, _c, _d;
        const participantJid = ((_b = (_a = getBinaryNodeChild(child, "participant")) === null || _a === void 0 ? void 0 : _a.attrs) === null || _b === void 0 ? void 0 : _b.jid) || participant;
        ...
        switch (child === null || child === void 0 ? void 0 : child.tag) {
            ...
            case "subject":
                ...
                break;
            case "description":
                const description = (_d = (_c = getBinaryNodeChild(child, "body")) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.toString();
        ...
        switch (nodeType) {
            ...
            case "picture":
                ...
                ev.emit("contacts.update", [
                    {
                        id: jidNormalizedUser((_a = node === null || node === void 0 ? void 0 : node.attrs) === null || _a === void 0 ? void 0 : _a.from) ||
    ...
    const sendMessagesAgain = async (key, ids, retryNode) => {
        ...
        const sendToAll = !((_a = jidDecode(participant)) === null || _a === void 0 ? void 0 : _a.device);
    ...
    const handleReceipt = async (node) => {
        ...
        const isNodeFromMe = areJidsSameUser(attrs.participant || attrs.from, isLid ? (_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.lid : (_b = authState.creds.me) === null || _b === void 0 ? void 0 : _b.id);
            ...
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    if (attrs.type === "retry") {
                        ...
                        if (ids[0] &&
                            key.participant &&
                            willSendMessageAgain(ids[0], key.participant)) {
                            if (key.fromMe) {
                                try {
    ...
    const handleMessage = async (node) => {
        ...
        if (response &&
            ((_a = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _a === void 0 ? void 0 : _a[0]) === NO_MESSAGE_FOUND_ERROR_TEXT) {
        ...
        if (!!alt) {
            const altServer = (_d = jidDecode(alt)) === null || _d === void 0 ? void 0 : _d.server;
        ...
        if (((_e = msg.key) === null || _e === void 0 ? void 0 : _e.remoteJid) && ((_f = msg.key) === null || _f === void 0 ? void 0 : _f.id) && messageRetryManager) {
            ...
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    if (msg.messageStubType === proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        if (((_a = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _a === void 0 ? void 0 : _a[0]) === MISSING_KEYS_ERROR_TEXT) {
                            return sendMessageAck(node, NACK_REASONS.ParsingError);
                        }
                        const errorMessage = ((_b = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _b === void 0 ? void 0 : _b[0]) || "";
