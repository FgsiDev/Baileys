...
const makeMessagesRecvSocket = (config) => {
    ...
    const { ev, authState, ws, processingMutex, signalRepository, query, upsertMessage, resyncAppState, onUnexpectedError, assertSessions, sendNode, relayMessage, sendReceipt, uploadPreKeys, getUSyncDevices, sendPeerDataOperationMessage, } = sock;
    ...
    const offerCall = async (toJid, isVideo = false) => {
        ...
        if (shouldIncludeDeviceIdentity) {
            offerContent.push({
                tag: "device-identity",
                attrs: {},
                content: (0, Utils_1.encodeSignedDeviceIdentity)(((_a = authState.creds) === null || _a === void 0 ? void 0 : _a.account) || {}, true),
            });
        }
        const stanza = {
            tag: "call",
            ...
            content: [
                {
                    ...
                    attrs: {
                        "call-id": callId,
                        "call-creator": (_c = (_b = authState.creds) === null || _b === void 0 ? void 0 : _b.me) === null || _c === void 0 ? void 0 : _c.id,
                    },
    ...
    const rejectCall = async (callId, callFrom) => {
        ...
        const stanza = {
            tag: "call",
            attrs: {
                from: (_b = (_a = authState.creds) === null || _a === void 0 ? void 0 : _a.me) === null || _b === void 0 ? void 0 : _b.id,
                to: callFrom,
            },
            content: [
                {
        ...
        if (reactionsList) {
            ...
            reactions.forEach((item) => {
                ...
                ev.emit("newsletter.reaction", {
                    id,
                    server_id: serverId,
                    reaction: { code: (_a = item.attrs) === null || _a === void 0 ? void 0 : _a.code, count: +((_b = item.attrs) === null || _b === void 0 ? void 0 : _b.count) },
                });
            });
        }
        if (viewsList.length) {
    ...
    const handleMexNewsletterNotification = (id, node) => {
        var _a;
        const operation = (_a = node === null || node === void 0 ? void 0 : node.attrs) === null || _a === void 0 ? void 0 : _a.op_name;
        const content = JSON.parse(node && node.content ? node.content.toString() : "");
        let contentPath;
        ...
        switch (nodeType) {
            ...
            case "picture":
                ...
                ev.emit("contacts.update", [
                    {
                        id: (0, WABinary_1.jidNormalizedUser)((_a = node === null || node === void 0 ? void 0 : node.attrs) === null || _a === void 0 ? void 0 : _a.from) ||
    ...
    const handleReceipt = async (node) => {
        ...
        const participant = fromMe
            ? (0, WABinary_1.jidNormalizedUser)((_c = authState.creds.me) === null || _c === void 0 ? void 0 : _c.id)
            : isLid
    ...
    const handleNotification = async (node) => {
        ...
        const isNodeFromMe = (0, WABinary_1.areJidsSameUser)(node.attrs.participant || remoteJid, isLid ? (_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.lid : (_b = authState.creds.me) === null || _b === void 0 ? void 0 : _b.id);
        const fromMe = !node.attrs.recipient ||
            ((node.attrs.type === "retry" || node.attrs.type === "sender") &&
                isNodeFromMe);
        const participant = fromMe
            ? (0, WABinary_1.jidNormalizedUser)((_c = authState.creds.me) === null || _c === void 0 ? void 0 : _c.id)
            : isLid
    ...
    const handleMessage = async (node) => {
        ...
        if (response &&
            ((_a = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _a === void 0 ? void 0 : _a[0]) === Utils_1.NO_MESSAGE_FOUND_ERROR_TEXT) {
            msg.messageStubParameters = [Utils_1.NO_MESSAGE_FOUND_ERROR_TEXT, response];
        }
        if (((_c = (_b = msg.message) === null || _b === void 0 ? void 0 : _b.protocolMessage) === null || _c === void 0 ? void 0 : _c.type) ===
                ...
                processingMutex.mutex(async () => {
                    ...
                    if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        ...
                        if ((_b = msg.key.participant) === null || _b === void 0 ? void 0 : _b.endsWith("@lid")) {
                            msg.key.participant =
                                node.attrs.participant_pn || ((_d = (_c = authState.creds) === null || _c === void 0 ? void 0 : _c.me) === null || _d === void 0 ? void 0 : _d.id);
                        }
