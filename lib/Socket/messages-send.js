            ...
            if (useCache) {
                ...
                if (devices) {
                    ...
                    const devicesWithWire = devices.map((d) => ({
                        ...d,
                        wireJid: isLidJid
                            ? (0, WABinary_1.jidEncode)(d.user, "lid", d.device)
                            : (0, WABinary_1.jidEncode)(d.user, "s.whatsapp.net", d.device),
                    }));
        ...
        if (force) {
            ...
            const migrateDeviceToLid = async (jid, lidForPN) => {
                if (!jid.includes("@s.whatsapp.net"))
                    return;
                try {
                    const lidWithDevice = (0, WABinary_1.transferDevice)(jid, lidForPN);
    ...
    const sendPeerDataOperationMessage = async (pdoMessage) => {
        ...
        const protocolMessage = {
            protocolMessage: {
                ...
                type: index_js_1.proto.Message.ProtocolMessage.Type
                    ...
                    if (result) {
                        if (result.error) {
                            ...
                            try {
                                ...
                                if (media.result !==
                                    index_js_1.proto.MediaRetryNotification.ResultType.SUCCESS) {
        ...
        sendAlbumMessage: async (jid, medias, options = {}) => {
            ...
            */
            ...
            const album = (0, Utils_1.generateWAMessageFromContent)(jid, {
                messageContextInfo: {
                    messageSecret: new Uint8Array((0, crypto_1.randomBytes)(32)),
                },
                albumMessage: {
