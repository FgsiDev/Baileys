...
import { aggregateMessageKeysNotFromMe, assertMediaContent, bindWaitForEvent, decryptMediaRetryData, encodeNewsletterMessage, encodeSignedDeviceIdentity, encodeWAMessage, encryptMediaRetryRequest, extractDeviceJids, generateMessageIDV2, generateWAMessage, generateWAMessageFromContent, getStatusCodeForMediaRetry, getUrlFromDirectPath, getWAUploadToServer, MessageRetryManager, normalizeMessageContent, parseAndInjectE2ESessions, unixTimestampSeconds, } from "../Utils";
import { getUrlInfo } from "../Utils/link-preview";
import { makeKeyedMutex } from "../Utils/make-mutex";
import { areJidsSameUser, getBinaryNodeChild, getBinaryNodeChildren, isJidGroup, isPnUser, jidDecode, jidEncode, jidNormalizedUser, S_WHATSAPP_NET, transferDevice, } from "../WABinary";
...
export const makeMessagesSocket = (config) => {
    ...
    const deduplicateLidPnJids = (jids) => {
        ...
        for (const jid of jids) {
            if (jid.includes("@lid")) {
                const user = (_a = jidDecode(jid)) === null || _a === void 0 ? void 0 : _a.user;
                if (user)
                    lidUsers.add(user);
            }
        }
        ...
        for (const jid of jids) {
            if (jid.includes("@s.whatsapp.net")) {
                const user = (_b = jidDecode(jid)) === null || _b === void 0 ? void 0 : _b.user;
    ...
    const getUSyncDevices = async (jids, useCache, ignoreZeroDevices) => {
        ...
        if (result) {
            const extracted = extractDeviceJids(result === null || result === void 0 ? void 0 : result.list, authState.creds.me.id, ignoreZeroDevices);
            const deviceMap = {};
            ...
            for (const [user, userJids] of userGroups) {
                ...
                const checkMigratedSession = async (jid) => {
                    ...
                    if (shouldMigrateUser &&
                        ...
                        const lidWithDevice = jidEncode(lidDecoded === null || lidDecoded === void 0 ? void 0 : lidDecoded.user, "lid", deviceId);
                        // Check if LID session exists
                        const lidSignalId = signalRepository.jidToSignalProtocolAddress(lidWithDevice);
                        const lidSessions = await authState.keys.get("session", [
                            lidSignalId,
                        ]);
                    ...
                    if (!hasSession) {
                        ...
                        logger.debug({
                            jid: jidToFetch,
                            originalJid: jid !== jidToFetch ? jid : undefined,
    ...
    const createParticipantNodes = async (jids, message, extraAttrs, dsmMessage) => {
        ...
        const meLidUser = meLid ? (_b = jidDecode(meLid)) === null || _b === void 0 ? void 0 : _b.user : null;
        ...
        const userEncryptionPromises = Array.from(devicesByUser.entries()).map(([user, userDevices]) => encryptionMutex.mutex(user, async () => {
            ...
            for (const { recipientJid: wireJid, patchedMessage } of userDevices) {
                ...
                if (dsmMessage) {
                    ...
                    const isExactSenderDevice = wireJid === meId ||
                        (((_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.lid) && wireJid === authState.creds.me.lid);
    ...
    const relayMessageB = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList, }) => {
        ...
        msgId = msgId || generateMessageIDV2((_b = sock.user) === null || _b === void 0 ? void 0 : _b.id);
        ...
        await authState.keys.transaction(async () => {
            ...
            if ((_a = normalizeMessageContent(message)) === null || _a === void 0 ? void 0 : _a.pinInChatMessage) {
            ...
            if (isGroup || isStatus) {
                ...
                if (!participant) {
                    ...
                    if (!isStatus) {
                        const groupAddressingMode = (groupData === null || groupData === void 0 ? void 0 : groupData.addressingMode) ||
                            (isLid
                ...
                if (!participant) {
                    ...
                    if ((additionalAttributes === null || additionalAttributes === void 0 ? void 0 : additionalAttributes["category"]) !== "peer") {
                        ...
                        const senderIdentity = isLid && meLid
                            ? jidEncode((_b = jidDecode(meLid)) === null || _b === void 0 ? void 0 : _b.user, "lid", undefined)
                            : jidEncode((_c = jidDecode(meId)) === null || _c === void 0 ? void 0 : _c.user, "s.whatsapp.net", undefined);
                        // Enumerate devices for sender and target with consistent addressing
                        const sessionDevices = await getUSyncDevices([senderIdentity, jid], false, false);
                        devices.push(...sessionDevices);
                        logger.debug({
                            deviceCount: devices.length,
                            devices: devices.map((d) => { var _a; return `${d.user}:${d.device}@${(_a = jidDecode(d.wireJid)) === null || _a === void 0 ? void 0 : _a.server}`; }),
            ...
            if (!isNewSletter &&
                ...
                ((_f = messages === null || messages === void 0 ? void 0 : messages.listMessage) === null || _f === void 0 ? void 0 : _f.listType) !== "PRODUCT_LIST") {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (!options.ephemeralExpiration) {
                if (isJidGroup(jid)) {
                    ...
                    const expiration = ((_b = (_a = getBinaryNodeChild(metadata, "ephemeral")) === null || _a === void 0 ? void 0 : _a.attrs) === null || _b === void 0 ? void 0 : _b.expiration) || 0;
            ...
            if (typeof content === "object" &&
                ...
                const fullMsg = await generateWAMessage(jid, content, {
                    ...
                    messageId: generateMessageIDV2((_c = sock.user) === null || _c === void 0 ? void 0 : _c.id),
                    ...options,
                });
                ...
                if (isDeleteMsg) {
                    ...
                    if (isJidGroup((_d = content.delete) === null || _d === void 0 ? void 0 : _d.remoteJid) &&
