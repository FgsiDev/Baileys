...
const makeSocket = (config) => {
    var _a, _b;
    const { waWebSocketUrl, connectTimeoutMs, logger, keepAliveIntervalMs, browser, auth: authState, printQRInTerminal, defaultQueryTimeoutMs, transactionOpts, qrTimeout, makeSignalRepository, customPairingCode, } = config;
    ...
    const waitForMessage = async (msgId, timeoutMs = defaultQueryTimeoutMs) => {
        ...
        try {
            ...
            if (error instanceof boom_1.Boom &&
                ((_a = error.output) === null || _a === void 0 ? void 0 : _a.statusCode) === Types_1.DisconnectReason.timedOut) {
                (_b = logger === null || logger === void 0 ? void 0 : logger.warn) === null || _b === void 0 ? void 0 : _b.call(logger, { msgId }, "timed out waiting for message");
                return undefined;
            }
            throw error;
        }
    ...
    const onWhatsApp = async (...jids) => {
        ...
        for (const jid of jids) {
            if ((0, WABinary_1.isLidUser)(jid)) {
                ...
                const phone = `+${(_a = jid.replace("+", "").split("@")[0]) === null || _a === void 0 ? void 0 : _a.split(":")[0]}`;
    ...
    const requestPairingCode = async (phoneNumber, code) => {
        ...
        authState.creds.pairingCode =
            ((_b = (_a = (code || customPairingCode || "")) === null || _a === void 0 ? void 0 : _a.toLocaleUpperCase) === null || _b === void 0 ? void 0 : _b.call(_a)) ||
                (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(5));
        if (authState.creds.pairingCode &&
            ((_c = authState.creds.pairingCode) === null || _c === void 0 ? void 0 : _c.length) !== 8) {
    ...
    ws.on("CB:success", async (node) => {
        ...
        ev.emit("creds.update", {
            me: {
                ...authState.creds.me,
                lid: node.attrs.lid,
                jid: (_c = (0, WABinary_1.jidDecode)((_b = (_a = authState === null || authState === void 0 ? void 0 : authState.creds) === null || _a === void 0 ? void 0 : _a.me) === null || _b === void 0 ? void 0 : _b.id)) === null || _c === void 0 ? void 0 : _c.user,
                runBy: "FgsiDev",
            },
        });
        ev.emit("connection.update", { connection: "open" });
        if (node.attrs.lid && ((_d = authState.creds.me) === null || _d === void 0 ? void 0 : _d.id)) {
