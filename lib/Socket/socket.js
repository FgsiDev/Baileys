...
import { DEF_CALLBACK_PREFIX, DEF_TAG_PREFIX, INITIAL_PREKEY_COUNT, MIN_PREKEY_COUNT, MIN_UPLOAD_INTERVAL, NOISE_WA_HEADER, UPLOAD_TIMEOUT, } from "../Defaults";
...
import { assertNodeErrorFree, binaryNodeToString, encodeBinaryNode, getBinaryNodeChild, getBinaryNodeChildren, isLidUser, jidEncode, S_WHATSAPP_NET, } from "../WABinary";
...
export const makeSocket = (config) => {
    ...
    const waitForMessage = async (msgId, timeoutMs = defaultQueryTimeoutMs) => {
        ...
        try {
            ...
            if (error instanceof Boom &&
                ((_a = error.output) === null || _a === void 0 ? void 0 : _a.statusCode) === DisconnectReason.timedOut) {
    ...
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        const pairingCode = customPairingCode !== null && customPairingCode !== void 0 ? customPairingCode : bytesToCrockford(randomBytes(5));
...
function mapWebSocketError(handler) {
    return (error) => {
        handler(new Boom(`WebSocket Error (${error === null || error === void 0 ? void 0 : error.message})`, {
