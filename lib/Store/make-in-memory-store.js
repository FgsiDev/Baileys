...
export const waLabelAssociationKey = {
    key: (la) => la.type === LabelAssociationType.Chat
...
export default (config) => {
    ...
    const defaultSettings = {
        /*activeAutoClearMsgDelete: false,
        enableMessageLogging: true,
        ignoreOnDemandHistorySync: true,
        clearMessagesOnSync: true,
        clearChatsOnSync: true,
        allowContactImageUpdates: true,
        autoAddUnknownChats: true,
        persistUnreadCount: true,
        allowLabeling: true,
        enableGroupMetadataUpdate: true,
        enablePresenceTracking: true,*/
        allowMessageDelete: true,
        /*allowMessageReactionHandling: true,
        allowReceiptUpdate: true,
        maxLabelsCount: 20,
        deleteUnknownContactsOnSync: true,
        debugMode: false,*/
    };
    const bind = (ev, options = {}) => {
        const settings = {
            ...defaultSettings,
            ...options,
        };
        ...
        if (settings === null || settings === void 0 ? void 0 : settings.allowMessageDelete)
