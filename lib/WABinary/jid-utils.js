...
/** is the jid a user */
export const areJidsSameUser = (jid1, jid2) => { var _a, _b; return ((_a = jidDecode(jid1)) === null || _a === void 0 ? void 0 : _a.user) === ((_b = jidDecode(jid2)) === null || _b === void 0 ? void 0 : _b.user); };
/** is the jid Meta AI */
