...
exports.getBinaryNodeMessages = exports.reduceBinaryNodeToDictionary = exports.assertNodeErrorFree = exports.getBinaryFilteredButtons = exports.getBinaryNodeChildUInt = exports.getBinaryNodeChildString = exports.getBinaryNodeChildBuffer = exports.getBinaryNodeChild = exports.getAllBinaryNodeChildren = exports.getBinaryNodeChildren = void 0;
...
const getBinaryFilteredButtons = (nodeContent) => {
    if (Array.isArray(nodeContent)) {
        return nodeContent.filter((item) => !(item.tag === "biz" &&
            item.content &&
            item.content.some((tag) => (tag.tag === "interactive" &&
                tag.attrs.type === "native_flow" &&
                tag.attrs.v === "1") ||
                (tag.tag === "list" &&
                    tag.attrs.type === "product_list" &&
                    tag.attrs.v === "2"))));
    }
    return nodeContent;
};
