...
export namespace Browsers {
    ...
    function linux(browser: any): any[];
    function solaris(browser: any): any[];
    function baileys(browser: any): any[];
    function android(browser: any): any[];
    function iOS(browser: any): any[];
    function kaiOS(browser: any): any[];
    function chromeOS(browser: any): any[];
    function appropriate(browser: any): any[];
    function custom(platform: any, browser: any, version: any): any[];
}
