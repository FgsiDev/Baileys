...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const senderPn = (_a = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null || _a === void 0 ? void 0 : _a.sender_pnAdd;
    ...
    const pushname = (_d = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null || _d === void 0 ? void 0 : _d.notify;
    const key = {
        remoteJid: chatId,
        fromMe,
        id: msgId,
        ...
        participant,
        participantLid,
        server_id: (_e = stanza.attrs) === null || _e === void 0 ? void 0 : _e.server_id,
    };
    const fullMessage = {
        key,
    ...
    if (msgType === "newsletter") {
        fullMessage.newsletterServerId = +((_f = stanza.attrs) === null || _f === void 0 ? void 0 : _f.server_id);
    }
    if (key.fromMe) {
