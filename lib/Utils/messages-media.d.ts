 ...
 */
export function getAudioWaveform(buffer: any, logger: any): Promise<Uint8Array | undefined>;
...
export function getWAUploadToServer({ customUploadHosts, fetchAgent, logger, options }: {
    ...
    logger: any;
    options: any;
}, refreshMediaConn: any): (filePath: any, { mediaType, fileEncSha256B64, timeoutMs }: {
    mediaType: any;
...
export function decryptMediaRetryData({ ciphertext, iv }: {
    ciphertext: any;
    iv: any;
}, mediaKey: any, msgId: any): Promise<proto.MediaRetryNotification>;
