 ...
 */
export const extractUrlFromText = (text) => { var _c; return (_c = text.match(URL_REGEX)) === null || _c === void 0 ? void 0 : _c[0]; };
...
export const generateWAMessageContent = async (message, options) => {
    ...
    if ("mentions" in message && ((_e = message.mentions) === null || _e === void 0 ? void 0 : _e.length)) {
