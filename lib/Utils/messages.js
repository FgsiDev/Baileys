...
const ButtonType = index_js_1.proto.Message.ButtonsMessage.HeaderType;
/**
...
const generateForwardMessageContent = (message, forceForward) => {
    ...
    let score = ((_d = (_c = content === null || content === void 0 ? void 0 : content[key]) === null || _c === void 0 ? void 0 : _c.contextInfo) === null || _d === void 0 ? void 0 : _d.forwardingScore) || 0;
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ("text" in message) {
        ...
        if (message.event.call && options.getCallLink) {
            ...
            m.eventMessage.joinLink =
                (message.event.call === "audio"
                    ? Defaults_1.CALL_AUDIO_PREFIX
                    : Defaults_1.CALL_VIDEO_PREFIX) + token;
        }
        m.messageContextInfo = {
            // encKey
        ...
        m.eventMessage.endTime = message.event.endDate
            ...
            : undefined;
        m.eventMessage.isCanceled = (_c = message.event.isCancelled) !== null && _c !== void 0 ? _c : false;
        m.eventMessage.extraGuestsAllowed = message.event.extraGuestsAllowed;
        m.eventMessage.isScheduleCall = (_d = message.event.isScheduleCall) !== null && _d !== void 0 ? _d : false;
        m.eventMessage.location = message.event.location;
    }
    else if ("payment" in message) {
        const { imageMessage } = ((_e = message === null || message === void 0 ? void 0 : message.payment) === null || _e === void 0 ? void 0 : _e.background_url)
        ...
        if (message.poll.selectableCount < 0 ||
            ...
            throw new boom_2.Boom(`poll.selectableCount in poll should be >= 0 and <= ${message.poll.values.length}`, {
                statusCode: 400,
            });
        }
        m.messageContextInfo = {
    ...
    if ("productList" in message && !!message.productList) {
        ...
        const image = ((_f = message === null || message === void 0 ? void 0 : message.header) === null || _f === void 0 ? void 0 : _f.image)
            ? await (0, exports.prepareWAMessageMedia)({ image: (_g = message === null || message === void 0 ? void 0 : message.header) === null || _g === void 0 ? void 0 : _g.image, ...options }, options)
            : null;
        const video = ((_h = message === null || message === void 0 ? void 0 : message.header) === null || _h === void 0 ? void 0 : _h.video)
            ? await (0, exports.prepareWAMessageMedia)({ video: (_j = message === null || message === void 0 ? void 0 : message.header) === null || _j === void 0 ? void 0 : _j.video, ...options }, options)
            : null;
        const document = ((_k = message === null || message === void 0 ? void 0 : message.header) === null || _k === void 0 ? void 0 : _k.document)
            ? await (0, exports.prepareWAMessageMedia)({ document: (_l = message === null || message === void 0 ? void 0 : message.header) === null || _l === void 0 ? void 0 : _l.document, ...options }, options)
            : null;
        const interactiveMessage = {
            viewOnceMessageV2Extension: {
                message: {
                    ...
                    interactiveMessage: index_js_1.proto.Message.InteractiveMessage.create({
                        contextInfo: message.contextInfo,
                        body: index_js_1.proto.Message.InteractiveMessage.Body.create({
                            text: message.text,
                        }),
                        footer: index_js_1.proto.Message.InteractiveMessage.Footer.create({
                            text: message.footer,
                        }),
                        header: index_js_1.proto.Message.InteractiveMessage.Body.create({
                            title: message.title,
                            subtitle: message.subtitle,
                            hasMediaAttachment: ((_m = message === null || message === void 0 ? void 0 : message.header) === null || _m === void 0 ? void 0 : _m.hasMediaAttachment) || false,
                            imageMessage: image ? image.imageMessage : null,
                            videoMessage: video ? video.videoMessage : null,
                            documentMessage: document ? document.documentMessage : null,
                            locationMessage: ((_o = message === null || message === void 0 ? void 0 : message.header) === null || _o === void 0 ? void 0 : _o.location) || null,
                            productMessage: ((_p = message === null || message === void 0 ? void 0 : message.header) === null || _p === void 0 ? void 0 : _p.product) || null,
                        }),
                        nativeFlowMessage: index_js_1.proto.Message.InteractiveMessage.NativeFlowMessage.create({
    ...
    if ("cards" in message && !!message.cards) {
        const cards = await Promise.all(message.cards.map(async (slide) => {
            ...
            return {
                body: index_js_1.proto.Message.InteractiveMessage.Body.fromObject({
                    text: body,
                }),
                footer: index_js_1.proto.Message.InteractiveMessage.Footer.fromObject({
                    text: footer,
                }),
                header: index_js_1.proto.Message.InteractiveMessage.Header.fromObject({
                    title,
        ...
        const interactiveMessage = {
            viewOnceMessageV2Extension: {
                message: {
                    ...
                    interactiveMessage: index_js_1.proto.Message.InteractiveMessage.fromObject({
                        contextInfo: message.contextInfo,
                        body: index_js_1.proto.Message.InteractiveMessage.Body.fromObject({
                            text: message.text,
                        }),
                        ...
                        header: index_js_1.proto.Message.InteractiveMessage.Body.fromObject({
                            title: message.title,
                            subtitle: message.subtitle,
                            hasMediaAttachment: false,
                        }),
                        carouselMessage: index_js_1.proto.Message.InteractiveMessage.CarouselMessage.fromObject({
                            cards,
                        }),
                    }),
                },
    ...
    if ("mentions" in message && ((_q = message.mentions) === null || _q === void 0 ? void 0 : _q.length)) {
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    if (quoted && !(0, WABinary_1.isJidNewsletter)(jid)) {
        ...
        const contextInfo = ("contextInfo" in innerMessage[key] && ((_c = innerMessage[key]) === null || _c === void 0 ? void 0 : _c.contextInfo)) ||
            {};
