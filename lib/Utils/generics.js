...
export const getKeyAuthor = (key, meId = "me") => ((key === null || key === void 0 ? void 0 : key.fromMe) ? meId : (key === null || key === void 0 ? void 0 : key.participant) || (key === null || key === void 0 ? void 0 : key.remoteJid)) || "";
...
export const toNumber = (t) => typeof t === "object" && t
    ? "toNumber" in t
        ? t.toNumber()
        : t.low
    : t || 0;
...
export const generateMessageID = () => {
    ...
    if (letterIndexes.length > 0) {
        let randomIndex = letterIndexes[Math.floor(Math.random() * letterIndexes.length)];
