...
export const isRealMessage = (message, meId) => {
    ...
    return ((!!normalizedContent ||
        ...
        (REAL_MSG_REQ_ME_STUB_TYPES.has(message.messageStubType) &&
            ((_a = message.messageStubParameters) === null || _a === void 0 ? void 0 : _a.some((p) => areJidsSameUser(meId, p))))) &&
        hasSomeContent &&
    ...
    if (protocolMsg) {
        switch (protocolMsg.type) {
            ...
            case proto.Message.ProtocolMessage.Type.LID_MIGRATION_MAPPING_SYNC:
                ...
                const encodedPayload = (_e = protocolMsg.lidMigrationMappingSyncMessage) === null || _e === void 0 ? void 0 : _e.encodedMappingPayload;
        ...
        ev.emit("messages.reaction", [
            {
                reaction,
                key: (_f = content.reactionMessage) === null || _f === void 0 ? void 0 : _f.key,
            },
        ]);
    }
    else if (message.messageStubType) {
        const jid = (_g = message.key) === null || _g === void 0 ? void 0 : _g.remoteJid;
        ...
        switch (message.messageStubType) {
            ...
            case WAMessageStubType.GROUP_CHANGE_ANNOUNCE:
                const announceValue = (_h = message.messageStubParameters) === null || _h === void 0 ? void 0 : _h[0];
                emitGroupUpdate({
                    announce: announceValue === "true" || announceValue === "on",
                });
                break;
            case WAMessageStubType.GROUP_CHANGE_RESTRICT:
                const restrictValue = (_j = message.messageStubParameters) === null || _j === void 0 ? void 0 : _j[0];
                emitGroupUpdate({
                    restrict: restrictValue === "true" || restrictValue === "on",
                });
                break;
            case WAMessageStubType.GROUP_CHANGE_SUBJECT:
                const name = (_k = message.messageStubParameters) === null || _k === void 0 ? void 0 : _k[0];
                chat.name = name;
                emitGroupUpdate({ subject: name });
                break;
            case WAMessageStubType.GROUP_CHANGE_DESCRIPTION:
                const description = (_l = message.messageStubParameters) === null || _l === void 0 ? void 0 : _l[0];
                chat.description = description;
                emitGroupUpdate({ desc: description });
                break;
            case WAMessageStubType.GROUP_CHANGE_INVITE_LINK:
                const code = (_m = message.messageStubParameters) === null || _m === void 0 ? void 0 : _m[0];
                emitGroupUpdate({ inviteCode: code });
                break;
            case WAMessageStubType.GROUP_MEMBER_ADD_MODE:
                const memberAddValue = (_o = message.messageStubParameters) === null || _o === void 0 ? void 0 : _o[0];
                emitGroupUpdate({ memberAddMode: memberAddValue === "all_member_add" });
                break;
            case WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_MODE:
                const approvalMode = (_p = message.messageStubParameters) === null || _p === void 0 ? void 0 : _p[0];
                emitGroupUpdate({ joinApprovalMode: approvalMode === "on" });
                break;
            case WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_REQUEST_NON_ADMIN_ADD:
                const participant = (_q = message.messageStubParameters) === null || _q === void 0 ? void 0 : _q[0];
